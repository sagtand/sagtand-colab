<?php
// Pagination
// Tips: Add an value when calling the function to set an hashtag and scroll to another position of the page. Ex: 'FoundationPress_pagination( "#news" );' to scroll to an element with id news.
function FoundationPress_pagination($hash = '') {
	// The Hash-variable is to whish id the page will scroll to when clickon on the pagination
